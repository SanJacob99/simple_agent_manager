...
/**
 * Strip reasoning/thinking XML tags from assistant text.
 * Handles `<think>`, `<thinking>`, `<thought>`, `<antthinking>`, and `<final>`.
 * Tags inside fenced code blocks or inline code spans are preserved.
 */
export function stripReasoningTagsFromText(text: string): string {
  ...
  // Strip <final> tags first (they're standalone markers, not wrappers)
  ...
  // Strip thinking tag pairs and their content
