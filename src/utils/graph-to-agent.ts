...
export function resolveAgentConfig(
  ...
  // At most one A2A node binds to an agent; it owns the single inbound server
  // surface plus the set of outbound remote delegates, so the first connected
  // node wins and resolves to a single optional value (or null), like reflection.
