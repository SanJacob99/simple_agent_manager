...
export function resolveAgentConfig(
  ...
  // At most one A2A node binds to an agent; it owns the single server mount and
  // the delegate registry, so the first connected node wins and resolves to a
  // single optional value (or null) rather than a list, mirroring reflection.
