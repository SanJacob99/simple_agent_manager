...
| `a2a` | Agent-to-Agent (A2A) protocol interop: publish an agent card + accept inbound tasks (server) and/or register remote A2A agents as callable delegates (client), with bearer auth and task-concurrency controls |
