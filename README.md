...
| `a2a` | Agent-to-Agent (A2A) interop: publish an agent card and accept remote tasks (server), and/or register remote A2A agents as callable delegates (client), for cross-framework agent interop |
