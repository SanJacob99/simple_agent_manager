...
| `a2a` | Agent-to-Agent interop: publish an agent card / accept remote tasks (server) and/or register remote A2A agents as callable delegates (client), for cross-framework agent interop over the A2A protocol |
