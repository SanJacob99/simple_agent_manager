...
| `reflection` | Wraps the finalize step in a draft → critique → revise loop: a critic scores the reply against a rubric and, below a threshold, feeds the critique back for up to N revisions |
