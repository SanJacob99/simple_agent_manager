...
| `a2a` | Agent-to-Agent (A2A) interop: publish an agent card and accept remote tasks, and/or register remote A2A agents as callable delegates — cross-framework interop, much as MCP standardized tools |
