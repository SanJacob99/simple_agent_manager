...
function summarizePayload(payload: any): string {
  ...
  // ⚡ Bolt Optimization: Use a decrementing loop instead of [...messages].reverse().find()
  // to avoid unnecessary O(N) array allocation and copying on the hot path for logging
  let lastUser;
